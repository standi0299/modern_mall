...
function uploadAppExecuteClickOnce(domain, param, storage_date_notice, storage_size_notice) 
{
	...
	if (storage_date_notice == "Y")
		alert('<?echo _("웹하드 사용기간이 만료되었습니다. 본사에 문의 하세요.")?>');
	//스토리지 사용량에 따른 메세지
	else if (storage_size_notice == "Y")
		alert('<?echo _("웹하드 사용량이 초과되었습니다. 본사에 문의 하세요.")?>');
	else
	{
...
function move_goods_view(goodsno){
   window.location.href = "/goods/view.php?goodsno="+goodsno;
}