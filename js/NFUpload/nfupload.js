...
NFUpload.prototype.Initialize = function (args) {
    ...
    this.SetValue("ImgFileBrowse", args.nf_img_file_browse, "NFUpload/images/btn_file_browse.gif");
    ...
    this.SetValue("ImgFileDelete", args.nf_img_file_delete, "NFUpload/images/btn_file_delete.gif");
    ...
    this.SetValue("EnableEncodingFilename", args.nf_enable_encoding_filename, "false");
};
...
NFUpload.prototype.GetFlashVars = function () {
    ...
    // [2013-09-13] 플래쉬 라이브러리 버그로 인한 파일명 인코딩 여부 추가.
    vars += "&EnableEncodingFilename=" + encodeURIComponent(this.GetValue("EnableEncodingFilename"));
