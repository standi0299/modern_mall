...
function add_addoptbox(){
	...
	var selectTag = "<select name=\"addopt_group_view["+addoptbox_idx+"]\"><option value=\"Y\">사용</option><option value=\"N\">" + '<?echo _("미사용")?>' + "</option></select>";	
	$j(td).html(selectTag);		
...
// pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\" onchange=\"numZeroChk(this);\"
	var td = document.createElement("td");
	$j(td).html("<input type=\"text\" style=\"width:30px;\" name=\"cnt_start["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\"/>(" + '<?echo _("에서")?>' + ") ~ <input type=\"text\" style=\"width:30px;\" name=\"cnt_end["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\" onchange=\"numZeroChk(this);\"/>(" + '<?echo _("까지")?>' + ") - <input type=\"text\" style=\"width:30px;\" name=\"cnt_step["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\" onchange=\"numZeroChk(this);\"/>(" + '<?echo _("씩 증가")?>' + ")");
	$j(td).attr("align","right");
	$j(td).appendTo(tr);

	var td = document.createElement("td");
	$j(td).html("<button onclick=\"remove_addcnt(this);return false;\">" + '<?echo _("삭제")?>' + "</button>");	
	$j(td).attr("align","center");
	$j(td).appendTo(tr);
...
function add_addcnt_printhome(obj){
	...
	var td = document.createElement("td");
	$j(td).html("<button class=\"btn btn-sm btn-default\" onclick=\"remove_addcnt(this);return false;\">" + '<?echo _("삭제")?>' + "</button>");	
	$j(td).appendTo(tr);
...
//<span name=\"cnt_start["+addcntbox_idx+"]\">" + cnt_start + "(에서)</span>
	var td = document.createElement("td");
	$j(td).html("<input type=\"text\" style=\"width:30px;\" name=\"after_cnt_start["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\"/>(" + '<?echo _("에서")?>' + ") ~ <input type=\"text\" style=\"width:30px;\" name=\"after_cnt_end["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\" onchange=\"numZeroChk(this);\"/>(" + '<?echo _("까지")?>' + ") - <input type=\"text\" style=\"width:30px;\" name=\"after_cnt_step["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\" onchange=\"numZeroChk(this);\"/>(" + '<?echo _("씩 증가")?>' + ")");
	$j(td).attr("align","right");
	$j(td).appendTo(tr);

	var td = document.createElement("td");
	$j(td).html("<button onclick=\"remove_addcnt_after(this);return false;\">" + '<?echo _("삭제")?>' + "</button>");	
	$j(td).attr("align","center");
	$j(td).appendTo(tr);
...
//<span name=\"cnt_start["+addcntbox_idx+"]\">" + cnt_start + "(에서)</span>
	...
	var td = document.createElement("td");
	$j(td).html("<button class=\"btn btn-sm btn-default\" onclick=\"remove_addcnt_after(this);return false;\">" + '<?echo _("삭제")?>' + "</button>");	
	$j(td).appendTo(tr);
...
// pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\" onchange=\"numZeroChk(this);\"
	var td = document.createElement("td");
	$j(td).html("<input type=\"text\" style=\"width:30px;\" name=\"unit_cnt_start["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\"/>(" + '<?echo _("에서")?>' + ") ~ <input type=\"text\" style=\"width:30px;\" name=\"unit_cnt_end["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\" onchange=\"numZeroChk(this);\"/>(" + '<?echo _("까지")?>' + ") - <input type=\"text\" style=\"width:30px;\" name=\"unit_cnt_step["+addcntbox_idx+"]\" pt=\"_pt_numplus\" onkeydown=\"_pattern(this);\" onchange=\"numZeroChk(this);\"/>(" + '<?echo _("씩 증가")?>' + ")");
	$j(td).attr("align","right");
	$j(td).appendTo(tr);
