                     ...
                     <tbody>
                        <? if($list) {?>
                           ...
                           <tr>
                              ...
                              <td>                                 
                                  <button type="button" class="btn btn-xs btn-danger" onclick="board_delete('<?=$value[board_id]?>','<?=$value[no]?>');">
                                     <?=_("삭제")?>
                                  </button>
                              </td>
                           </tr>
...
//삭제
function board_delete(board_id,no) {
   if(confirm('<?=_("정말 삭제하시겠습니까?")?>'))
      location.href = "indb.php?mode=del&board_id="+board_id+"&no="+no;
}
</script>
