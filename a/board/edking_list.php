...
$m_board = new M_board();
$m_goods = new M_goods();
$r_bottommenu = array("edking_best"=>_("베스트수정"),"edking_emoney"=>_("적립금발급"),"edking_delete"=>_("일괄삭제"));

$cfg[edking_save_days] = getCfg('edking_save_days');
if (!$cfg[edking_save_days]) $cfg[edking_save_days] = "15";
		         ...
		         <form class="form-horizontal form-bordered" method="post" action="edking_list.php">
			         ...
			         <div class="form-group">
			         	...
			         	<label class="col-md-4 control-label">
			               <?=_("편집왕파일 보관기간")?> : <b><?=$cfg[edking_save_days]?></b><?=_("일")?>
			            </label> 
			         	<div class="col-md-1">
