...
if ($data[img]) {
	$size = getimagesize("../../data/review/$cid/$data[img]");
...
<div id="content" class="content">
   ...
   <h1 class="page-header"><?=_("상품후기")?> <small><?=_("상품후기 정보를 등록하실 수 있습니다.")?>.</small></h1>

   <div class="row">
      <div class="col-md-12">
         <div class="panel panel-inverse">
            <div class="panel-heading">
               <h4 class="panel-title"><?=_("상품후기 등록")?><h4>
            </div>
            ...
            <form class="form-horizontal form-bordered" name="fm" method="POST" action="indb.php" enctype="multipart/form-data" onsubmit="return chkForm(this)">
               <input type="hidden" name="mode" value="review_admin">
               <input type="hidden" name="mid" value="<?=$sess_admin[mid]?>">
			   <input type="hidden" name="payno" value="0">
			   <input type="hidden" name="ordno" value="0">
			   <input type="hidden" name="ordseq" value="0">
               <input type="hidden" name="original_emoney" value="0">
			   <input type="hidden" name="rurl" value="/a/board/review.php">

               <div class="form-group">
                  <label class="col-md-2 control-label"><?=_("상품코드")?></label>
                  <div class="col-md-4 form-inline">
                     <input type="text" name="goodsno" class="form-control" required type2="number">
                  </div>
                  <label class="col-md-2 control-label"><?=_("상품분류코드")?></label>
                  <div class="col-md-4 form-inline">
                     <input type="text" name="catno" class="form-control" type2="number">
                  </div>                  
               </div>
               
               <div class="form-group">
                  <label class="col-md-2 control-label"><?=_("작성자 아이디")?></label>
                  <div class="col-md-4 form-inline">
                     <input type="text" name="review_mid" class="form-control">
                  </div>
                  <label class="col-md-2 control-label"><?=_("작성자명")?></label>
                  <div class="col-md-4 form-inline">
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10">
                     <? foreach ($r_kind as $k => $v) { ?>
                        <input type="radio" name="kind" class="radio-inline" value="<?=$k?>" <?if($k=="normal"){?>checked<?}?>> <?=$v?>
                     <? } ?>
                  </div>
               </div>
               ...
               <!--<div class="form-group">
                  ...
                  <div class="col-md-10">
					<input type="radio" name="review_deny_admin" class="radio-inline" value="0" checked> <?=_("노출")?>
					<input type="radio" name="review_deny_admin" class="radio-inline" value="1"> <?=_("노출안함")?>                    
                  </div>
               </div>-->
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10">
					<input type="radio" name="review_deny_user" class="radio-inline" value="0" checked> <?=_("노출")?>
					<input type="radio" name="review_deny_user" class="radio-inline" value="1"> <?=_("노출안함")?>               
                  </div>
               </div>
               ...
               <div class="form-group">
           	   ...
           	   <div class="form-group" id="kind_photo">
