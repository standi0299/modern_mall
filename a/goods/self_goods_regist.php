...
* @date : 2018-06-14
* @author : kjm
* @brief : PODS 2.0 페이지 설정 기본값 0 세팅
* @request : 팀장 문승규 요청 (검색 : [BluePOD] 기본,최소,최대 페이지 수 기본값 설정 요청의 건)
*/
...
$checked[editor_active_exe][active] = "selected";
...
//견적정보 / 20180517 /kdk
$checked[extra_print_product]["DG01"] = "checked";
               ...
               <form class="form-horizontal form-bordered" name="fm" method="POST" action="indb.php" enctype="multipart/form-data" onsubmit="return submitContents(this);">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-2 form-inline">
						      <select name="tem_catno" class="form-control"><option value="" style="background:#656263;color:#FFFFFF;">+ <?=_("템플릿 분류 선택")?></option><?=conv_selected_option($tem_ca_list, "")?></select>
                     </div>
                  </div>
                        ...
                        <tr>
                        	...
                        	<td>
                        		...
                        		<span id="msg_auto_pay" class="desc small red" style="display: none; margin-left: 85px;">
                                 <div>
                        			   <br>(<?=_("자동견적결제를 선택하지 않는 경우 이 상품은 견적의뢰 프로세스로 처리되며 상품 등록 후 운영 중에는 변경이 불가능 합니다.")?>)
                     			   </div>
                        		</span>
                        ...
                        <div id="pods_div" <?if(!$data[podskind]){?>style="display:none"<?}?>>
                           <table class="tb1" style="margin:5px 0;">
                              ...
                              <tr>
                                 <th><?=_("상품분류")?></th>
                                 <td>
                                    <input type="text" class="form-control" name="podskind" id="podskind" onblur="myFunction(this)"/>
                                 </td>
                                 <td>
                  ...
                  <div id="cover_range_view" class="form-group" style="display: none;">
                     <label class="col-md-2 control-label"><?=_("커버혼용북 옵션설정")?></label>
                     <div class="col-md-10">
                        <table class="table table-bordered table-hover" id="cover_ragne">
                           
                           <tr>
                              <td colspan="6">
                                 <span onclick="cover_ragne_opt('<?=$cnt1?>')">추가</span>
                           ...
                           <tr>
                              ...
                              -->
                              <td class="col-md-2">
                                 <input type="text" name="cover_range[]" id="cover_range_<?=$cnt?>" onblur="make_cover_id('<?=$cnt?>');" class="form-control">
                              </td>
                              
                              <td>
                                 <select name="cover_type[]" id="cover_type_<?=$cnt?>" onchange="make_cover_id('<?=$cnt?>');" class="form-control">
                              ...
                              <td><input type="text" name="cover_paper_code[]" id="cover_paper_<?=$cnt?>" onblur="make_cover_id('<?=$cnt?>');" class="form-control"></td>
                              <td><input type="text" name="cover_paper_name[]" class="form-control"></td>
                              <td><input type="text" name="cover_goods_price[]" class="form-control"></td>
                              <td><input type="text" name="cover_page_addprice[]" class="form-control"></td>
                              <td class="col-md-2"><input type="text" name="cover_id[]" id="cover_id_<?=$cnt?>" onclick="make_cover_id('<?=$cnt?>');" class="form-control" readonly></td>
                           </tr>
                           <? $cnt1 = $cnt+1; } ?>
                        </table>
                     </div>
                     ...
                     <div class="col-md-10">
                        <table class="table table-bordered table-hover">
                           ...
                           <tr>
                              ...
                              <td><input type="text" name="cover_id_range[]" class="form-control"></td>
                              <td><input type="text" name="page[]"   class="form-control"></td>
                              <td><input type="text" name="width[]"  class="form-control"></td>
                              <td><input type="text" name="height[]" class="form-control"></td>
                              <td><input type="text" name="back[]"   class="form-control"></td>
                              <td><input type="text" name="left[]"   class="form-control"></td>
                              <td><input type="text" name="right[]"  class="form-control"></td>
                              <td><input type="text" name="up[]"     class="form-control"></td>
                              <td><input type="text" name="down[]"   class="form-control"></td>
                           </tr>
                           <? } ?>
                        </table>
                     </div>

                     <label class="col-md-2 control-label"><?=_("json 데이터 입력")?></label>
                     <div class="col-md-10">
                        <?=_("그룹 번호")?> : 1-정방형, 2-세로형, 3-가로형, 4-10x8<input type="text" class="form-control" name="group_num">
                        json : <textarea name="json_data" class="form-control" style="width:100%;height:400px"></textarea>
                     </div>
                  </div>
                  ...
                  function click_pods_div(mode){
                     ...
                     if (mode=="2" || mode=="3"){
                        ...
                        $j("#podskind").css("display","inline");
                        $j("#podskind_sel").css("display","none");
                        $j("#edit_type").css("display","none");
                        $j("#cover_range_view").slideUp();
                        if (mode == "2"){

                           //$j("#podskind").css("display","none");
                           $j("#podskind_sel").css("display","inline");
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-10">
                        <input type="radio" name="usestock" value="0" class="form-contorl" <?=$checked[usestock][0]?>/> <?=_("재고와 상관없이 무제한으로 판매(재고관리 안함)")?>
                        <input type="radio" name="usestock" value="1" class="form-contorl" <?=$checked[usestock][1]?>/> <?=_("재고가 있을 경우만 판매(출고완료시 자동감소)")?>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-5">
                        ...
                        <div id="shipping_0" style="display:none"><?=_("제작사의 배송정책을 따릅니다.")?></div>
                        <div id="shipping_1" style="display:none"><?=_("배송비가")?> <b><?=_("무료")?></b><?=_("입니다 (판매자부담)")?></div>
                        <div id="shipping_2" style="display:none">
                        <?=_("개별배송비")?> <input type="text" name="shipprice" value="<?=$data[shipprice]?>" class="form-control-inline" pt="_pt_numplus"/> <?=_("원")?> 
                        (<?=_("배송비원가")?> <input type="text" name="oshipprice" value="<?=$data[oshipprice]?>" class="form-control-inline" pt="_pt_numplus"/> <?=_("원")?>)
                        </div>
                           ...
                           <tbody>
                              ...
                              <tr align="center">
                                 ...
                                 <td>
                                    ...
                                    <a class="btn btn-success btn-icon btn-circle btn_get_productid" onclick="_get_productid(0,$j(this).prev())" <?if($is_podskind20 || $data[pods_use]=="0" || $data[pods_use]=="3"){?>style="display:none"<?}?>><i class="fa fa-repeat"></i></a>
                                 </td>
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-md-2 control-label"><?=_("리스트")?></label>f
                        <div class="col-md-6">
