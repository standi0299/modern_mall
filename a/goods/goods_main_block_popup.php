				...
				<div class="panel panel-inverse">
				    ...
				    <form class="form-horizontal" method="post" action="indb.php">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>              	
                            	<?
                            	foreach ($main_block as $key => $value) {
                            		if($blockArr[$key]) {    
                            		  $val = $blockArr[$key];
										//debug($val);
								?>
                                <tr>
                                    ...
                                    <td><a href="javascript:;" onclick="block_update('<?=$val[ID]?>','<?=$key?>','<?=$val[display_text]?>','<?=$val[order_by]?>','<?=$val[display_data]?>','<?=$val[display_img]?>', '<?=$val[state]?>');"><?=$val[display_text]?></a></td>
                                </tr>
								<?
								    }
                                    else {
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td><a href="javascript:;" onclick="block_update('','<?=$key?>','<?=$value?>','','','', '');"><?=$key?></a></td>
                                    <td><a href="javascript:;" onclick="block_update('','<?=$key?>','<?=$value?>','','','', '');"><?=$value?></a></td>
                                </tr>                              
                                <?
                                    }	
								}
...
function block_update(bId,bCode,bText,bOrder,bType,bImg,bState) {
	...
	$("img[name=ex_img]").attr("src","http://mmdevtest.bluepod.kr/data/main_block/"+bCode+".PNG");
