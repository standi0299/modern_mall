...
<div id="content" class="content">
   ...
   <h1 class="page-header"><?=_("제작사 수정")?></h1>
         ...
         <div class="panel panel-inverse">
            ...
            <div class="panel-body panel-form">
               <form class="form-horizontal form-bordered" name="fm" method="POST" action="indb.php" onsubmit="return form_chk(this);">
                  ...
                  <div class="form-group">
                     <label class="col-md-2 control-label"><?=_("착불배송방식")?></label>
                     <div class="col-md-10">
...
function chk_password(val){
   ...
   if (!fm.password.value){
      ret1.innerHTML = '<?=_("비밀번호를 입력해주세요")?>';
      fm.password.focus();
      return false;
   } else if (!_pattern(fm.password)){
      ret1.innerHTML = '<?=_("비밀번호는 영소문자,숫자,-,_ 를 사용하여 6~20자로 입력해주세요.")?>';
      fm.password.focus();
      fm.password.value = "";
      return false;
   }
   ret1.innerHTML = '<?=_("등록 혹은 비밀번호 변경시에만 입력해주세요")?>';
   ...
   ret2.innerHTML = (fm.password.value!=fm.password2.value) ? '<?=_("비밀번호 불일치")?>' : '<?=_("비밀번호 일치")?>';
