<?
//스튜디오 견적 프리셋1 (100110) 2015.03.03 by kdk
?>
<div id="preset_div" name="preset_div" preset="100110">
...
<div class="addoptbox_div2">
  ...
  <tr>
    <td width="120" align="center"><?=_("필수")?></td>
...
<? if ($cid == $cfg_center[center_cid] || $checkRegCid) { ?>
	<? if ($extra_stu_order == "EXT") { //스튜디오견적이면 설정하고 스튜디오업로드면 필수?>
      <?=MakeUseflagSelect('use_flag_3', $clsExtraOption->GetOptionKindUse("3"))?>
      <!--<input type="image" src="../img/sbtn_apply.gif" style="vertical-align: middle; width: 27px; height: 17px;" onclick="saveDisplayFlag('use_flag_3','3');return false;" />--> 
	<?  } else { ?>
		필수
	<? } ?>	
<?  } ?>
...
<?  } ?>    
  ...
  <tr>
    ...
    <td><?=$clsExtraOption->MakeSelectOptionTag("10","","documentOnchange")?></td>
    <td width="120" align="center">
<?// if ($cid == $cfg_center[center_cid] || $checkRegCid) { ?>
      <a href="javascript:;" onclick="openAddOption('10','DOCUMENT','0','<?=$clsExtraOption->GetDisplayName("10")?>','<?=$clsExtraOption->GetExtraData1("10")?>','<?=$clsExtraOption->GetExtraData2("10")?>','',this); return false;"><u><?=_("추가")?></u></a>
<?//  } ?>      
      <a href="javascript:;" onclick="openEdiOption('DOCUMENT','10',this); return false;"><u><?=_("관리")?></u></a>      
    </td>
  </tr>     
...
<? if ($cid == $cfg_center[center_cid] || $checkRegCid) { ?>    	
	<?// if ($extra_stu_order == "EXT") { //스튜디오견적이면 설정하고 스튜디오업로드면 필수?>	
      <?=MakeUseflagSelect('use_flag_11', $clsExtraOption->GetOptionKindUse("11"))?>
      <input type="image" src="../img/sbtn_apply.gif" style="vertical-align: middle; width: 27px; height: 17px;" onclick="saveDisplayFlag('use_flag_11','11');return false;" /> 
	<?//  } else { ?>
		<!--필수-->
	<?// } ?>
<?} else { ?>
	<?if ($clsExtraOption->GetOptionKindUse("11") == "Y") {?>
	<?} else { ?>
		<?=_("미사용")?>
	<?} ?>	
<?  } ?>
    ...
    <td><?=$clsExtraOption->MakeSelectOptionTag("11","","documentOnchange")?>
    </td>
    <td width="120" align="center">
<? if ($cid == $cfg_center[center_cid] || $checkRegCid) { ?>
      	<a href="javascript:;" onclick="openAddOption('11','DOCUMENT','0','<?=$clsExtraOption->GetDisplayName("11")?>','<?=$clsExtraOption->GetExtraData1("11")?>','<?=$clsExtraOption->GetExtraData2("11")?>','',this); return false;"><u><?=_("추가")?></u></a>
      	<a href="javascript:;" onclick="openEdiOption('DOCUMENT','11',this); return false;"><u><?=_("관리")?></u></a>
<?} else { ?>
	<?if ($clsExtraOption->GetOptionKindUse("11") == "Y") {?>
		<a href="javascript:;" onclick="openAddOption('11','DOCUMENT','0','<?=$clsExtraOption->GetDisplayName("11")?>','<?=$clsExtraOption->GetExtraData1("11")?>','<?=$clsExtraOption->GetExtraData2("11")?>','',this); return false;"><u><?=_("추가")?></u></a>
      	<a href="javascript:;" onclick="openEdiOption('DOCUMENT','11',this); return false;"><u><?=_("관리")?></u></a>
