      ...
      <div class="panel panel-inverse">
         ...
         <div class="panel-body panel-form">
            <div class="form-group">
               ...
               <div class="col-md-4">
                  <input type="radio" name="etype" value="0" <?=$checked[etype][0] ?> /><?=_("미사용")?>
                  <input type="radio" name="etype" value="1" <?=$checked[etype][1] ?> /><?=_("사용")?>
               </div>
               <label class="col-md-6 control-label">
                  <!--<span class="pull-left"><?=_("- 수동 진행 : 관리자가 진행을 선택합니다.") ?></span><br>
                  <span class="pull-left"><?=_("- 자동 진행 : 자동으로 진행합니다.") ?></span><br>-->
                  <?=_("이벤트")?> URL : /service/attend_event.php</br>
			   </label>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <div class="col-md-4">
                  <div class="input-group input-daterange">
                     <input type="text" class="form-control" name="sdate" placeholder='<?=_("시작일")?>' value="<?=$data[sdate]?>" required />
                     <span class="input-group-addon"> ~ </span>
                     <input type="text" class="form-control" name="edate" placeholder='<?=_("종료일")?>' value="<?=$data[edate]?>" required />
                  </div>
               </div>
               <label class="col-md-6 control-label">
            ...
            <div class="form-group">
               ...
               <div class="col-md-4 form-inline">
                  <input type="text" class="form-control" name="count_tot" value="<?=$data[count_tot] ?>" size="5" /> <?=_("누적 횟수 참여") ?> / 
