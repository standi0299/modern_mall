...
include "../_left_menu.php";
   ...
   $sql = "select value from exm_config where config = 'naver_site_verification' and cid ='$cid'";
   $naver_site_verification = $db->fetch($sql);
...
<div id="content" class="content">
   ...
   <div class="panel panel-inverse"> 
      ...
      <ul class="nav nav-tabs">
				<li class="active"><a href="#default-tab-1" data-toggle="tab"><?=_("공통정보 설정")?></a></li>
				<li class=""><a href="#default-tab-2" data-toggle="tab"><?=_("상품 분류 설정")?></a></li>
				<li class=""><a href="#default-tab-3" data-toggle="tab"><?=_("상품 상세 설정")?></a></li>
			</ul>
      ...
      <input type="hidden" name="mode" value="seo">	
          ...
          <div class="form-group">
             <label class="col-md-2 control-label"><?=_("네이버")?> 소유확인 메타태그<br/>(빨간색 content부분만 입력)<br/>             
             ex ) &lt;meta name="naver-site-verification"content=<font style="color:red">content</font> /&gt;
             </label>
             <div class="col-md-10">
                <input class="form-control" name="naver_site_verification" value="<?=$naver_site_verification[value]?>"></textarea>
             </div>
          </div>
				</div>
          ...
          <div class="form-group">
             <label class="col-md-2 control-label"><?=_("예약어 안내")?></label>
             <div class="col-md-10">
                {{<?=_("상품분류명")?>}} : <?=_("현재 카테고리명을 출력합니다.")?><br>                
             </div>
          </div>     
				</div>
          ...
          <div class="form-group">
             <label class="col-md-2 control-label"><?=_("예약어 안내")?></label>
             <div class="col-md-10">
                {{<?=_("상품명")?>}} : <?=_("현재 상품명을 출력합니다.")?><br>                
                {{<?=_("상품검색어")?>}} : <?=_("현재 상품에 등록된 검색어를 출력합니다.")?><br>
                {{<?=_("상품판매가격")?>}} : <?=_("현재 상품에 등록된 판매가격을 출력합니다.(상품 옵션 가격 무시)")?><br>
             </div>
          </div>
				</div>
