...
$count[1] = $m_pretty -> getListCount_modern($cid, "and paystep != 0 and paystep != -1 and c.itemstep = '1'", "Y");
...
$count[3] = $m_pretty -> getListCount_modern($cid, "and paystep != 0 and paystep != -1 and c.itemstep = '3'", "Y", "Y");
   ...
   <div class="col-md-12 col-sm-6">
      <div class="widget widget-state bg-aqua-darker">
         <div class="btn-group pull-right">
            <button type="button" class="btn btn-sm btn-info" onclick="location.href='/a/order/order_list.php?itemstep=2';"><?=_("무통장-입금완료")?></button>
            <button type="button" class="btn btn-sm btn-info" onclick="location.href='/a/order/order_list.php?itemstep=92';"><?=_("신용거래-승인완료")?></button>
         </div>
      </div>
   </div>
</div>
