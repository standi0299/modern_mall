               ...
               <form class="form-horizontal form-bordered" name="fm" method="POST" action="indb.shipping.php" enctype="multipart/form-data" target="ifrmProc">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-10 form-inline">
                        ...
                        <a href="../_sample/shipcode.xls" class="btn btn-primary btn-xs m-r-5"><?=_("예제 다운")?></a>
                        <div class="desc"><span class="warning">[<?=_("주의")?>]</span> <?=_("xls파일이나 csv파일을 업로드 하셔야 합니다.")?></div>
                     </div>
                  </div>
