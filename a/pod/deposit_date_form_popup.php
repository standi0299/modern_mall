...
* @date : 20181114
* @author : kdk
* @brief : POD용 (알래스카) 입금일자 -> 입금정보 수정 폼.
* @request : 
* @desc :
* @todo :
*/
      ...
      <div id="header" class="header navbar navbar-default navbar-fixed-top">
         <div class="container-fluid">
            <div class="navbar-header">
               <a href="javascript:window.close();opener.parent.location.reload();" class="navbar-brand"><span class="navbar-logo"></span><?=_("입금정보 수정")?></a>
            </div>
         </div>
      </div>
      ...
      <div class="panel panel-inverse">
         <div class="panel-body">
            <form class="form-horizontal form-bordered" method="POST" action="indb.php" onsubmit="return submitForm(this)">
                <input type="hidden" name="mode" value="deposit_date_update"/>
                        ...
                        <tr class="active">
                            ...
                            <td>
                                <div class="input-daterange">
                                    <input type="text" class="form-control" name="deposit_date" placeholder="입금일자" value="<?=$data[deposit_date]?>" style="width: 120px;">
                                </div>
                            </td>
                        </tr>
                        <tr class="active">
                           ...
                           <td>
                                <select name="deposit_method" class="form-control" style="width: 200px;" required>
                                    ...
                                    <?foreach($r_deposit_method as $k=>$v){?>
                                        <option value="<?=$k?>" <?if($data[deposit_method] == $k){?>selected<?}?>><?=$v?></option>
                                    <?}?>
                                </select>
                           </td>
                        </tr>
