...
$checked[promise_date_yn][$_POST[promise_date_yn]] = "checked";
?>
...
<div id="content" class="content">
   ...
   <h1 class="page-header"><?=_("회원미수금현황 리스트")?> <small><?=_("회원 미수금 현황을 보실 수 있습니다.")?></small></h1>

   <div class="row">
      <div class="col-md-12">
         <div class="panel panel-inverse">
            <div class="panel-heading">
               <h4 class="panel-title"><?=_("회원미수금현황 리스트")?></h4>
            </div>

            <div class="panel-body panel-form">
               <form class="form-horizontal form-bordered" name="fm" method="post" action="remain_member_list.php">
                  <div class="panel-body">
                      <div class="form-group">
                         ...
                         <label class="col-md-1 control-label"><?=_("약속일자 존재여부")?></label>
                         <div class="col-md-2 form-inline">
                            <input type="checkbox" name="promise_date_yn" value="Y" <?=$checked[promise_date_yn]["Y"]?> /> <?=_("존재")?>
                         </div>
                      </div>                      
                      <div class="form-group">
                         <label class="col-md-1 control-label"><?=_("검색")?></label>
                         <div class="col-md-6 form-inline">
                            <input type="text" name="sword" class="form-control" value="<?=$_POST[sword]?>" size="100" placeholder='<?=_("아이디,회원명, 사업자명, 사업자번호, 미수담당자를 입력해주세요.")?>'>
                         </div>
                        <div class="col-md-4">
...
function dnExcel() {
    ...
    hidden_frm.location.href = "../order/indb.php?mode=dnExcel&kind=remain_member_pod&query=" + query;
}
</script>
   ...
   $(document).ready(function() {
      $('#data-table').dataTable({
         ...
         "bAutoWidth": false,
            ...
            url: './remain_member_list_page.php?postData=<?=$postData?>',
