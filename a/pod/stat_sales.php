...
if (array_notnull($_POST[receiptdt])){ //접수일시
   if ($_POST[receiptdt][0]) $addwhere2 .= " and receiptdt>='{$_POST[receiptdt][0]}'";
   if ($_POST[receiptdt][1]) $addwhere2 .= " and receiptdt<='{$_POST[receiptdt][1]}'";
}
...
$query = $m_pod->getStatSalesList($cid, $addwhere, $addwhere2, $orderby, "", true);
...
<div id="content" class="content">
   ...
   <h1 class="page-header"><?=_("매출현황")?> <small><?=_("매출현황을 보실 수 있습니다.")?></small></h1>

   <div class="row">
      <div class="col-md-12">
         <div class="panel panel-inverse">
            <div class="panel-heading">
               <h4 class="panel-title"><?=_("매출현황")?></h4>
            </div>

            <div class="panel-body panel-form">
               <form class="form-horizontal form-bordered" name="fm" method="post" action="stat_sales.php">
                  <div class="panel-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <button type="button" class="btn btn-sm btn-default" onclick="popup('stat_sales_detail_popup.php?postData=<?=$postData?>',1200,750)"><?=_("자세히보기")?></button>
                        </div>
                      </div>
                     <br>
   ...
   $(document).ready(function() {
      $('#data-table').dataTable({
         ...
         "bAutoWidth": false,
            ...
            url: './stat_sales_page.php?postData=<?=$postData?>',
