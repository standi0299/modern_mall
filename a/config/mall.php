      ...
      <div class="panel-body panel-form">
      	 ...
      	 <div class="form-group">
      	 	...
      	 	<div class="col-md-10 form-inline">
      	 		<input type="text" class="form-control" name="self_podsiteid" value="<?=$data[self_podsiteid]?>" size="40" pt="_pt_podsid"> (<?=_("소문자, 숫자, 5자이상만 가능합니다.")?>)
      	 		<div><span class="warning">[<?=_("주의")?>]</span> <?=_("몰내의 센터와는 독립된 자체상품 운영시에 입력해주세요.")?></div>
      	 		<div><span class="notice">[<?=_("설명")?>]</span> <?=_("상품을 소유한 사이트아이디입니다.")?></div>
      	 	</div>
      	 </div>
      	 ...
      	 <div class="form-group">
      	 	...
      	 	<div class="col-md-3 form-inline">
      	 		<b><?=$data[source_save_days]?></b><?=_("일")?>
      	 	</div>
      	 	<label class="col-md-2 control-label"><?=_("썸네일이미지 보관기간")?></label>
      	 	<div class="col-md-3 form-inline">
      	 		<b><?=$data[thum_save_days]?></b><?=_("일")?>
      	 	</div>
      	 </div>
