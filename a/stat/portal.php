...
$r_portal = array("naver"=>_("네이버"),"daum"=>_("다음"),"google"=>_("구글"),"yahoo"=>_("야후"),"nate"=>_("네이트"),"about"=>_("어바웃"));
$r_method = array(
	"naver"		=> array("etc"=>_("검색/기타")),
	"daum"		=> array("etc"=>_("검색/기타")),
	"google"	=> array("etc"=>_("검색/기타")),
	"yahoo"		=> array("etc"=>_("검색/기타")),
	"nate"		=> array("etc"=>_("검색/기타")),
	"about"		=> array("etc"=>_("검색/기타")),
);
$r_adtype = array(
	"shopping"	=> _("쇼핑"),
	"mail"		=> _("메일"),
