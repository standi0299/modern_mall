      ...
      <div class="panel-body panel-form">
      	 <div class="form-group">
      	 	...
      	 	<div class="col-md-3">
      	 		<div data="one" class="fa fa-chevron-left fa-lg cursorPointer year_left"></div> 
      	 			<span id="year_val_one"><?=date("Y")?></span><?=_("년")?> 
      	 		...
      	 		<div data="one" class="fa fa-chevron-left fa-lg cursorPointer month_left"></div> 
      	 			<span id="month_val_one"><?=date("m")?></span><?=_("월")?> 
         ...
         <div class="form-group">
      	 	...
      	 	<div class="col-md-3">
      	 		<div data="two" class="fa fa-chevron-left fa-lg cursorPointer year_left"></div> 
      	 			<span id="year_val_two"><?=date("Y")?></span><?=_("년")?> 
      	 		...
      	 		<div data="two" class="fa fa-chevron-left fa-lg cursorPointer month_left"></div> 
      	 			<span id="month_val_two"><?=date("m")?></span><?=_("월")?> 
         ...
         <div class="panel-body">
         	<div class="table-responsive">
         		<div><span class="notice">[<?=_("설명")?>]</span> <?=_("발급기간 입력시 지정된 발급기간중 1일이라도 발급이 가능한 쿠폰이 조회됩니다.")?></div>
         		<div><span class="notice">[<?=_("설명")?>]</span> <?=_("사용기간은 고객의 쿠폰사용일을 나타내며, 아래 표에서 사용수에 영향을 미칩니다.")?></div><p>
         		<div><span class="notice">[<?=_("설명")?>]</span> <?=_("발행수는 쿠폰생성시 관리자가 입력한 쿠폰발급 개수입니다.")?></div>
         		<div><span class="notice">[<?=_("설명")?>]</span> <?=_("등록수는 쿠폰생성후 관리자에 의해 지급되었거나 사용자의 다운로드 및 오프라인쿠폰으로 등록된 개수입니다.")?></div>
         		<div><span class="notice">[<?=_("설명")?>]</span> <?=_("사용수는 실제적으로 사용자가 주문을 통하여 사용된 개수입니다.")?></div><p>
