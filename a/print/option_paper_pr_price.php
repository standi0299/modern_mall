...
$mode = "paper_pr_price_update";
$title = "가격설정";
$url = "option_paper_pr_price_excel.php?filename=paper_pr";
...
if ($bExcelImport) {
    //엑셀에서 가격정보 읽어오기
    $tablePriceContent = GetPaperPrPriceDataXlsTag($excelImportFileName);
}
else {
    $tablePriceContent = GetPaperPrPriceDataTag($paperPriceDataArr);
}
...
$tableTitleContent = "
        <tr>
            ...
            <th rowspan='2'>헤배(1000x1000)</th>            
            <th rowspan='2'>A1(841x594)</th>            
            <th rowspan='2'>A2(420x594)</th>
            <th rowspan='2'>A3(297x420)</th>
            <th rowspan='2'>A4(210x297)</th>            
            <th rowspan='2'>B2(515x728)</th>            
            <th rowspan='2'>B3(364x515)</th>
            <th rowspan='2'>B4(257x364)</th>            
            <th rowspan='2'>B5(176x250)</th>
        </tr>
        <tr>
            <th>분류</th>
            <th>용지명</th>
