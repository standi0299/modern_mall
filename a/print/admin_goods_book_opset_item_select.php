...
<div id="content" class="content">
   ...
   <h1 class="page-header"><?=_("옵셋 책자 설정")?></h1>

   <form class="form-horizontal form-bordered" name="fm" method="POST" action="admin_indb.php">
   <input type="hidden" name="mode" value="goods_book_opt_sel" />
   
   <div class="panel panel-inverse"> 
      <div class="panel-heading">
         <h4 class="panel-title"><?=_("표지 항목 설정")?></h4>
      </div>
...
<?
    $optionData = adminGetOptionAllItems("SIZE", "A");

    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[size], "opt_size");  
    $optionData = adminGetOptionAllItems("SIZE", "B");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[size], "opt_size");
?>
            </div>
         </div>
         ...
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("표지날개")?></label>
            <div class="col-md-10 form-inline">
<?
    $optionData = adminGetOptionAllItems("WING");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[outside_wing], "outside_opt_wing");  
?>
            </div>
         </div>

         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("표지용지")?></label>
            <div class="col-md-3">
일반지<BR>
<?
    ...
    //debug($optionData);
    echo adminMakePaperOptionCheckTag($optionData, $printGoodsItem[outside_paper], "outside_opt_paper");
?>
<br><BR>일반색지<BR>
<?
...
?>
         ...
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("인쇄(앞면)")?></label>
            <div class="col-md-3 form-inline">
<?
    $optionData = adminGetOptionAllItems("PRINT");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[outside_print], "outside_opt_print"); 
?>
            </div>
            <label class="col-md-2 control-label"><?=_("인쇄(뒷면)")?></label>
            <div class="col-md-4 form-inline">
<?
    $optionData = adminGetOptionAllItems("PRINT");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[outside_print_back], "outside_opt_print_back"); 
?>
            </div>            
         </div>
         
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("표지코팅")?></label>
            <div class="col-md-10">
<?
    $optionData = adminGetOptionAllItems("GLOSS");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[outside_gloss], "outside_opt_gloss"); 
?>  
            </div>
         </div>
<!--
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("표지스코딕스")?></label>
            <div class="col-md-10">
<?
    $optionData = adminGetOptionAllItems("SC");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[outside_sc], "outside_opt_sc");    
?>
            </div>
         </div>         

         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("표지스코딕스 박")?></label>
            <div class="col-md-10">
<?
    $optionData = adminGetOptionAllItems("SCB");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[outside_scb], "outside_opt_scb");   
?>
            </div>
         </div>
-->
   ...
   <div class="panel panel-inverse"> 
      <div class="panel-heading">
         <h4 class="panel-title"><?=_("내지 항목 설정")?></h4>
      </div>

      <div class="panel-body panel-form">
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("내지용지")?></label>
            <div class="col-md-3">
일반지<BR>
<?
    $optionData = adminGetOptionPaperItems("PNM");
    //debug($printGoodsItem[outside_paper]);
    //debug($optionData);
    echo adminMakePaperOptionCheckTag($optionData, $printGoodsItem[inside_paper], "inside_opt_paper");
?>
<br><BR>일반색지<BR>
<?
    $optionData = adminGetOptionPaperItems("PNC");
...
?>
         ...
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("내지인쇄")?></label>
            <div class="col-md-10 form-inline">
<?
    $optionData = adminGetOptionAllItems("PRINT");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[inside_print], "inside_opt_print");  
?>
            </div>
         </div>
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("내지코팅")?></label>
            <div class="col-md-10 form-inline">
<?
    $optionData = adminGetOptionAllItems("GLOSS");
...
?>
   ...
   <div class="panel panel-inverse"> 
      <div class="panel-heading">
         <h4 class="panel-title"><?=_("간지/면지 항목 설정")?></h4>
      </div>

      <div class="panel-body panel-form">
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("간지/면지용지")?></label>
            <div class="col-md-3">
일반지<BR>
<?
    $optionData = adminGetOptionPaperItems("PNM");
    //debug($printGoodsItem[outside_paper]);
    //debug($optionData);
    echo adminMakePaperOptionCheckTag($optionData, $printGoodsItem[inpage_paper], "inpage_opt_paper");
?>
<br><BR>일반색지<BR>
<?
    $optionData = adminGetOptionPaperItems("PNC");
...
?>
         ...
         <div class="form-group">
            <label class="col-md-2 control-label"><?=_("간지/면지인쇄")?></label>
            <div class="col-md-10 form-inline">
<?
    $optionData = adminGetOptionAllItems("PRINT");
    echo adminMakeOptionCheckTag($optionData, $printGoodsItem[inpage_print], "inpage_opt_print");  
?>
            </div>
         </div>
      </div>
