...
//가격 정보.
$priceDataArr = GetPaperPrDcDataArr();
//debug($priceDataArr);
...
$objPHPExcel -> getActiveSheet() -> SetCellValue(getExcelColName(0) . 1, "수량");
$objPHPExcel -> getActiveSheet() -> SetCellValue(getExcelColName(1) . 1, "할인율(100분율, %)");
