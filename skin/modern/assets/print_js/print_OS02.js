...
function getList(src)
{
	...
	var url = "/print/get_option_list_book.php";
...
{
	//if (isValidOption()) {
		calcuPriceProc("fm_print", "/print/option_calcu_opset_book.php");
	//}
}