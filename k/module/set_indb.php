      ...
      *,
      ...
      if(
        ...
        while ($data = $db -> fetch($res)) {
            ...
            echo "<div>상품번호 : <b class='eng'>" . $data[goodsno] . "</b></div>";
         ...
         foreach ($_FILES[img][name] as $k => $v) {
            ...
            switch ($name[2]) {
               ...
               case "13" :
                  ...
                  break;
               default :
                  msg("gif,jpg,png,swf 형식의 파일만 업로드가 가능합니다.", -1);
                  break;
            }
             ...
             if (is_uploaded_file($_FILES[img_on][tmp_name][$k])) {
                 ...
                 switch ($name[2]) {
                     ...
                     case "3" :
                         ...
                         break;
                     default :
                         msg("오버이미지는 gif,jpg,png 형식의 파일만 업로드가 가능합니다.", -1);
                         break;
                 }
