		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs nav-tabs-inverse">
					<? if ($banner_type_img) { ?><li class=""><a href="#default-tab-1" data-toggle="tab"><?=_("기본 이미지 배너")?></a></li><?}?>
					<? if ($banner_text_img) { ?><li class=""><a href="#default-tab-2" data-toggle="tab"><?=_("텍스트 배너")?></a></li><?}?>
					<? if ($banner_edit_img) { ?><li class="active"><a href="#default-tab-3" data-toggle="tab"><?=_("에디터 배너")?></a></li><?}?>
				</ul>
