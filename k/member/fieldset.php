...
if (!$cfg[register_sms_auth_msg])
	$cfg[register_sms_auth_msg] = "인증번호는 [{인증번호}] 입니다.";	
?>
      ...
      <div class="panel panel-inverse">
         ...
         <div class="panel-body panel-form">
            <div class="form-group">
               ...
               <div class="col-md-4">
                  	<input type="radio" name="basestate" value="0" <?=$checked[basestate][0]?>/> 인증절차없음
					<input type="radio" name="basestate" value="1" <?=$checked[basestate][1]?>/> 관리자 인증 후 가입
               </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <div class="col-md-4">
                  	<input type="radio" name="register_sms_auth" value="0" <?=$checked[register_sms_auth][0]?>/> 사용하지 않음
					<input type="radio" name="register_sms_auth" value="1" <?=$checked[register_sms_auth][1]?>/> 사용함
               </div>
               <label class="col-md-6 control-label">
      ...
      <div class="panel panel-inverse">
         <div class="panel-heading">
            <div class="panel-heading-btn">
               <i class="fa fa-exclamation-triangle"></i> (개정된 정보통신망법에 의거 주민등록번호는 수집하지 못하게 되어 있습니다. 반드시 확인하시기 바랍니다.)            	
            </div>
            <h4 class="panel-title"><?=_("회원가입항목설정")?>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="delField"/> 초기화</h4>
         </div>
