            ...
            <div class="panel-body panel-form">
               <form class="form-horizontal form-bordered" method="post">
	               ...
	               <div class="form-group">
	                  ...
	                  <div class="col-md-3">
	                    <input type="radio" name="coupon_use" value="" checked/> 전체
						<input type="radio" name="coupon_use" value="0" <?=$checked[coupon_use][0]?>/> 미사용
						<input type="radio" name="coupon_use" value="1" <?=$checked[coupon_use][1]?>/> 사용
	                  </div>
	                  <div class="col-md-2">
