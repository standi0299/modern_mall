...
foreach ($list as $key => $value) {
	...
	$pdata[] = ($value[coupon_issuedt])? substr($value[coupon_issuedt],2,14) : "";
   	$pdata[] = ($data[coupon_issue_yn])?"등록":"미등록";
	$pdata[] = $value[mid];
	$pdata[] = "<a href=\"indb.php?mode=del_coupon_issue&coupon_issue_code=$value[coupon_issue_code]\" onclick=\"return confirm('정말로 삭제하시겠습니까?')\"><span class=\"btn btn-xs btn-danger\">삭제</span></a>";
