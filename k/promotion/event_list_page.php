...
foreach ($list as $key => $value) {
   ...
   $pdata[] = "<a href=\"event_write.php?eventno=$value[eventno]\"><span class=\"btn btn-xs btn-primary\">수정</span></a>";
   $pdata[] = "<a href=\"indb.php?mode=delEvent&eventno=$value[eventno]\" onclick=\"return confirm('"._("정말로 삭제하시겠습니까?")."')\"><span class=\"btn btn-xs btn-danger\">삭제</span></a>";
