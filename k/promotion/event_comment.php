...
$r_bottommenu = array("event_emoney"=>"적립금발급");
		      ...
		      <div class="panel-body panel-form">
		         <form class="form-horizontal form-bordered" method="post" action="event_comment.php">
			         ...
			         <div class="form-group">
	          	 	 ...
	          	 	 <div class="form-group">
			         	...
			         	<div class="col-md-10 form-inline">
			         		...
			         		<div><span class="notice">[설명]</span> 아이디 또는 코멘트를 검색합니다.</div>
			         	</div>
			         </div>
			         ...
			         <div class="form-group">
			            ...
			            <div class="col-md-10">
			               <input type="radio" class="radio-inline" name="emoney" value="0" <?=$checked[emoney][0]?>> 전체
			      	 	   <input type="radio" class="radio-inline" name="emoney" value="1" <?=$checked[emoney][1]?>> 미지급
			      	 	   <input type="radio" class="radio-inline" name="emoney" value="2" <?=$checked[emoney][2]?>> 지급
			            </div>
			         </div>
			         ...
			         <div class="form-group">
			            ...
			            <div class="col-md-8">
			               <input type="radio" class="radio-inline" name="hidden" value="0" <?=$checked[hidden][0]?>> 전체
			      	 	   <input type="radio" class="radio-inline" name="hidden" value="2" <?=$checked[hidden][2]?>> 미노출
			      	 	   <input type="radio" class="radio-inline" name="hidden" value="1" <?=$checked[hidden][1]?>> 노출
			            </div>
			            <div class="col-md-2">
