   ...
   <div class="panel panel-inverse"> 
      ...
      <div class="panel-body panel-form">
         ...
         <div class="form-group">
            ...
            <div class="col-md-10">
               <input type="radio" class="radio-inline" name="use_comment" value="0" <?=$checked[use_comment][0]?>> 사용안함
      	 	   <input type="radio" class="radio-inline" name="use_comment" value="1" <?=$checked[use_comment][1]?>> 사용
            </div>
         </div>
