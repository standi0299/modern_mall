...
$url_query = "/k/promotion/indb.php?query=".$_query;
//debug($_query);
//debug($url_query);
            ...
            <div class="panel-body panel-form">
               <form class="form-horizontal form-bordered" method="post">
	               ...
	               <div class="form-group">
	                  ...
	                  <div class="col-md-3">
						<input type="radio" name="coupon_issue_yn" value="" checked/> 전체
						<input type="radio" name="coupon_issue_yn" value="0" <?=$checked[coupon_issue_yn][0]?>/> 미등록
						<input type="radio" name="coupon_issue_yn" value="1" <?=$checked[coupon_issue_yn][1]?>/> 등록
	                  </div>
	                  <div class="col-md-2">
