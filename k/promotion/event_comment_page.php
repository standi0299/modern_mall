...
foreach ($list as $key => $value) {
   ...
   if ($value[emoney]) $pdata[] = "<div>지급완료</div>";
   ...
   else if (!$value[emoney] && $value[name]) $pdata[] = "<button type=\"button\" class=\"btn btn-xs btn-primary\" onclick=\"popup('event_emoney_popup.php?no=$value[no]', 600, 420)\">적립</button>";
   else $pdata[] = "";
