               ...
               <form class="form-horizontal form-bordered" name="fm" method="POST" action="indb.php" onsubmit="return submitContents(this);">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-2 form-inline">
						<!--현재 카테고리에 사용후기 공유 사용유무 추가 2017.04.28 by kdk-->
						<input type="checkbox" name="share_category_review_flag" value="1" class="absmiddle" <?=$checked[share_category_review_flag]?> /><span class="stxt absmiddle">현재 카테고리에 후기 공유</span>                     
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-2">
                        ...
                        <u class="hand" onclick="popup('goods.p.php?podsno=<?=$data[podsno]?>&optionid=1',400,160)"><?=_("제작대행")?></u>
                        <? } ?>
                     </div>
                     ...
                     <div class="col-md-10">
			            <div class="table-responsive">
			               <table class="table table-bordered table-hover">
			                  ...
			                  ?>
			                     <tr>
			                     	<td><?=$data[goods_desc][$i][name]?></td>
			   						<td><?=$data[goods_desc][$i][value]?></td>			   					
			                     </tr>
			                  <?
                           }
			                  ?>
			            ...
			            <div class="table-responsive">
			               <table class="table table-bordered table-hover">
			                  ...
			                  ?>
			                     <tr>
			                     	<td>
			                     		<input type="text" class="form-control" name="goods_desc[<?=$i?>][name]" value="<?=$data[mall_goods_desc][$i][name]?>"/>
			                     	</td>
			   						<td>
			   							<input type="text" class="form-control" name="goods_desc[<?=$i?>][value]" value="<?=$data[mall_goods_desc][$i][value]?>"/>
			   						</td>			   					
			                     </tr>
			                  <?
						         }
                  ...
                  <div class="form-group">
                     ...
                     ?>
                     <div class="desc"><?=_("기본설정>자체배송비설정 이 '사용함'으로 설정되어있을 경우 자체배송비 정책을 따릅니다.")?></div>
                     </div>
                  </div>
                        ...
                        <table class="table table-hover table-bordered">
                           ...
                           <tbody>
                              ...
                              <tr align="center">
                                 ...
                                 <u class="hand" onclick="javascript:popup('goods.p.php?podsno=<?=$data[podsno]?>&optionid=<?=$v[podoptno]?>',400,160)"><?=_("제작대행")?></u>
                                 </td>
                              </tr>
                              <? } ?>
                           </tbody>
                                       ...
                                       <div class="addoptbox_div" addoptbox_idx="<?=$k?>">
                                          ...
                                          <table class="table table-bordered">
                                             ...
                                             <tr align="center">
                                                ...
                                                <td><input type="text" class="form-control" name="addopt_aprice[<?=$k?>][<?=$k2?>]" value="<?=$v2[mall_addopt_aprice]?>"/></td>
                                                <td><input type="text" class="form-control" name="addopt_areserve[<?=$k?>][<?=$k2?>]" value="<?=$v2[mall_addopt_areserve]?>"/></td>
                                                <td><input type="text" class="form-control" name="mall_addopt_cprice[<?=$k?>][<?=$k2?>]" value="<?=$v2[mall_addopt_cprice]?>"/></td>
                                                <td>
