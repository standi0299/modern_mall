                        ...
                        <table id="opt_tb" class="table table-hover table-bordered">
                           ...
                           <tbody>
                              ...
                              <tr align="center">
                                 ...
                                 <td><input type="text" class="form-control" name="podsno[<?=$v[optno]?>]" value="<?=$v[podsno]?>" /><b class="stxt red hand" onclick="_get_productid(0,$j(this).prev())"><img src="../img/bt_check_s.png" class="absmiddle"/></b></td>
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 form-inline">
                           ...
                           <? if ($data[img][$i]){ ?>
                              <img src="../img/bt_preview.png" align="absmiddle" onclick="vLayer(this.nextSibling)" class="hand absmiddle"/><div style="display:none;"><img src="http://<?=$cfg_center[host]?>/data/goods/l/<?=$data[goodsno]?>/<?=$data[img][$i]?>"></div>
                           <? } ?>
                        </div>
                        <div class="col-md-2">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 form-inline">
                           ...
                           <? if ($data[listimg]){ ?>
                           <img src="../img/bt_preview.png" align="absmiddle" onclick="vLayer(this.nextSibling)" class="hand absmiddle"/><div style="display:none;"><img src="http://<?=$cfg_center[host]?>/data/goods/s/<?=$data[goodsno]?>/<?=$data[listimg]?>"></div>
                           <? } ?>
                        </div>
                        <div class="col-md-2">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 form-inline">
                           ...
                           <? if ($data[listimg_w]){ ?>
                           <img src="../img/bt_preview.png" align="absmiddle" onclick="vLayer(this.nextSibling)" class="hand absmiddle"/><div style="display:none;"><img src="http://<?=$cfg_center[host]?>/data/goods/s/<?=$data[goodsno]?>/<?=$data[listimg_w]?>"></div>
                           <? } ?>
                        </div>
                        <div class="col-md-2">
                        </div>
