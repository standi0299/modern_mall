         ...
         <div class="panel panel-inverse">
            ...
            <div class="panel-body panel-form">
               <form class="form-horizontal form-bordered" name="fm" method="POST" action="indb.php" onsubmit="return submitContents(this);">
                  ...
                  <div class="form-group">
                     <label class="col-md-2 control-label"><?=_("상품상세이미지너비")?></label>
                     <div class="col-md-10 form-inline">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-10 form-inline">
                        ...
                        <input type="text" name="rows" class="form-control" value="<?=$cfg[rows]?>"/> (열×행)
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-10">
                        ...
                        <div>스킨의 상단분류메뉴의 하위분류 슬라이드 여부를 결정합니다. - 지원가능한 스킨(basic) 에만 적용됩니다.</div>
                     </div>
                  </div>
<!--
	#자동견적 메뉴 생성 후 이동 예정
...
-->                  
            ...
            <div style="border:2px solid #DEDEDE;padding:10px;">
               <p><span>[확인]</span> 상품의 이미지사이즈는 상품등록시 설정된 사이즈로 자동으로 변경됩니다.</p>
               <p><span>[확인]</span> 상품리스트 출력방식은 상품분류의 출력방식을 지정하지 않았을때 나오는 기본형식입니다.</p>
            </div>
         </div>
      </div>
   </div>
