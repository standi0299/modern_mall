      ...
      <div class="panel-body panel-form">
         <div class="form-group">
            ...
            <div class="col-md-10 form-inline">
               ...
               ( 상품 번호 : <b class="blue"> <?=$goods[goodsno]?></b> )
               <div>센터 판매가 : <b class="red" style="font-size:12pt">￦ <?=number_format($goods[price])?></b></div>
               <? if ($goods[pageprice]){ ?>
               센터 페이지 추가가격 : <b class="red"><?=number_format($goods[pageprice])?></b>
               <? } ?>
               <div class="small red">* 가격정보를 공란으로 입력시에는,<br/> 센터정보,몰정보 순으로 상위의 정보를 쇼핑몰에서 참조하게 됩니다.</div>
            </div>
         </div>
      </div>
   </div>
