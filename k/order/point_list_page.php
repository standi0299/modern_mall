...
foreach ($list as $key => $value) {
   ...
   if ($value[account_flag] < 20)
      $pdata[] = "<a href=\"javascript:popup('popup_order_detail.php?payno=$value[payno]&mid=$value[mid]',1010,800);\">$value[payno]</a>";
   else
      $pdata[] = "<a href=\"javascript:popup('popup_charge_detail.php?tno=$value[tno]&mid=$value[mid]',300,210);\">$value[tno]</a>";
