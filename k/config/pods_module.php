      ...
      <div class="panel-body panel-form">
      	 <div class="form-group">
      	 	...
      	 	<div class="col-md-10 form-inline">
      	 		...
      	 		<div><span class="notice">[설명]</span> x,y,width,height^maximize 또는 normal와 같이 설정해주시면 됩니다. (예:0,0,1024,680^normal)</div>
      	 	</div>
      	 </div>
      </div>
   </div>
      ...
      <div class="panel-body panel-form">
      	 <div class="form-group">
      	 	...
      	 	<div class="col-md-10">
      	 		...
      	 		<div><span class="notice">[설명]</span> 기본적으로 출력되는 INTRO로 카테고리 INTRO를 사용할 경우 해당 INTRO는 출력되지 않습니다.</div>
      	 		<div>
      	 			<span class="notice">[설명]</span> 정보치환코드<br />
	      	 	    <div class="textIndent">총판매금액 : {price_total}</div>
	      	 	    <div class="textIndent">총적립금 : {reserve_total}</div>
	      	 	    <div class="textIndent">상품판매가격 : {price}</div>
	      	 	    <div class="textIndent">상품적립금 : {reserve}</div>
	      	 	    <div class="textIndent">기본옵션판매가격 : {price_opt}</div>
	      	 	    <div class="textIndent">기본옵션적립금 : {reserve_opt}</div>
	      	 	    <div class="textIndent">추가옵션판매가격 : {price_addopt}</div>
	      	 	    <div class="textIndent">추가옵션적립금 : {reserve_addopt}</div>
	      	 	    <div class="textIndent">제조사 : {release}</div>
	      	 	    <div class="textIndent">브랜드 : {brand}</div>
	      	 	    <div class="textIndent">배송비 : {shipprice}</div>
	      	 	    <div class="textIndent">수량 : {ea}</div>
	      	 	    <div class="textIndent">제작기간 : {leadtime}</div>
      	 		</div>
      	 	</div>
      	 </div>
      </div>
      ...
      <div class="panel-body panel-form">
      	 <div class="form-group">
      	 	...
      	 	<div class="col-md-10 form-inline">
			   	...
			   	<? if (is_file("../../data/pod/$cid/pod_logo.png")) { ?><input type="checkbox" class="form-control" name="d[pod_logo]/"> 로고 삭제<? } ?>
			   	<div><span class="warning">[주의]</span> <b>157px * 21px</b> 이하 사이즈의 <b>png</b> 파일로 업로드해주세요.</div>
      	 	</div>
      	 </div>
      </div>
   </div>
      ...
      <div class="panel-body panel-form">
      	 <div class="form-group">
      	 	...
      	 	<div class="col-md-10 form-inline">
			   	...
			   	<? if (is_file("../../data/pod/$cid/pod_title.png")) { ?><input type="checkbox" class="form-control" name="d[pod_title]/"> 타이틀 삭제<? } ?>
			   	<div><span class="warning">[주의]</span> <b>60px * 11px</b> 이하 사이즈의 <b>png</b> 파일로 업로드해주세요.</div>
      	 	</div>
      	 </div>
      </div>
   </div>  
