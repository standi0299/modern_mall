...
if (!$cfg[bill_yn]) $checked[bill_yn][0] = "checked";
if (!$cfg[bill_vat_yn]) $checked[bill_vat_yn][0] = "checked";
      ...
      <div class="panel-body panel-form">
         ...
         <div class="form-group">
            ...
            <div class="col-md-10 form-inline">
               <input type="text" class="form-control" name="bill_zipcode" value="<?=$cfg[bill_zipcode]?>" readonly>
               <i class="fa fa-search cursorPointer" onclick="javascript:popupZipcode<?=$language_locale?>()"></i><br><br>
               <input type="text" class="form-control" name="bill_address" value="<?=$cfg[bill_address]?>" size="100">
            </div>
         </div>
         ...
         <div class="form-group">
            ...
            <div class="col-md-10 form-inline">
			   ...
			   <? if (is_file("../../data/bill/$cid/bill_seal.png")) { ?><input type="checkbox" class="form-control" name="d[bill_seal]/"> 직인 삭제<? } ?>
			   <div><span class="warning">[주의]</span> <b>52px * 52px</b> 이하 사이즈의 <b>png</b> 파일로 업로드해주세요.</div>
            </div>
         </div>
