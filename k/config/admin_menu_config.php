...
<div id="content" class="content">
  ...
  <ol class="breadcrumb pull-right">
    ...
    <li class="active">메뉴 설정</li>
  </ol>
      
  <h1 class="page-header">메뉴 설정 <small><?=$center_cid?> >> <?=$cid?></small></h1>
...
<?
  ...
  $data = "!";
  if ($data)  
    $r_priv = unserialize($data[menu_priv]);
?>
...
?>
  	...
  	<td class="" style="text-align:center;">
    	...
    	<option value="<?=$subvalue?>" style="background-color:<?=$_r_admin_menu_select_color[9]?>;" <?if($r_priv[$nameFolder][$nameSection][$namePage]==$subvalue){?>selected<? } ?>>사용함 </option>
    	<option value="N" style="background-color:<?=$_r_admin_menu_select_color[0]?>;" <?if($r_priv[$nameFolder][$nameSection][$namePage] == "N"){?>selected<? } ?>>사용하지 않음</option>    
  	</select>  
  	</td>
	</tr>
...
?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-10">
                <button type="submit" class="btn btn-sm btn-success">저 장</button>
