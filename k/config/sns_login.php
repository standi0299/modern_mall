   ...
   <div class="panel panel-inverse"> 
      ...
      <div class="panel-body panel-form">
      	 <div class="form-group">
      	 	...
      	 	<div class="col-md-10">
      	 		<input type="radio" class="radio-inline" name="sns_login_use" value="N" <?=$checked[sns_login_use][N]?>> 사용안함
      	 		<input type="radio" class="radio-inline" name="sns_login_use" value="Y" <?=$checked[sns_login_use][Y]?>> 사용
      	 	</div>
      	 </div>
      	 
      	 <div class="notView" id="sns_login_use_div">
	      	 <div class="form-group">
	      	 	<label class="col-md-2 control-label"><?=_("네이버계정로그인<br>사용여부")?></label>
	      	 	<div class="col-md-10">
	      	 		<input type="radio" class="radio-inline" name="naver_login_use" value="N" <?=$checked[naver_login_use][N]?> onclick="divHide(this);"> 사용안함
      	 			<input type="radio" class="radio-inline" name="naver_login_use" value="Y" <?=$checked[naver_login_use][Y]?> onclick="divShow(this);"> 사용
	      	 	</div>
	      	 </div>
	      	 ...
	      	 <div class="form-group notView" id="naver_login_use_div">
	      	 	...
	      	 	<div class="col-md-10 form-inline">
	      	 		...
	      	 		<div><span class="notice">[설명]</span> 네이버계정로그인 연동설정시 네이버 개발자센터(<a href="https://developers.naver.com/main" target="_blank"><b>https://developers.naver.com/main</b></a>)를 통해 발급받은 Client ID / Client Secret를 등록해야 정상적으로 연동이 됩니다.</div>
	      	 		<div>
	      	 			<span class="notice">[설명]</span> 네이버 개발자센터에서 서비스 URL과 Callback URL을 확인해주세요.<br>
	      	 			<div class="textIndent">서비스 URL : http://<?=$_SERVER['SERVER_NAME']?></div>
	      	 			<div class="textIndent">Callback URL : http://<?=$_SERVER['SERVER_NAME']?>/_auth/callback_naver.php</div>
	      	 		</div>
	      	 	</div>
	      	 </div>
	      	 
	      	 <div class="form-group">
	      	 	<label class="col-md-2 control-label"><?=_("카카오계정로그인<br>사용여부")?></label>
	      	 	<div class="col-md-10">
	      	 		<input type="radio" class="radio-inline" name="kakao_login_use" value="N" <?=$checked[kakao_login_use][N]?> onclick="divHide(this);"> 사용안함
      	 			<input type="radio" class="radio-inline" name="kakao_login_use" value="Y" <?=$checked[kakao_login_use][Y]?> onclick="divShow(this);"> 사용
	      	 	</div>
	      	 </div>
	      	 ...
	      	 <div class="form-group notView" id="kakao_login_use_div">
	      	 	...
	      	 	<div class="col-md-10 form-inline">
	      	 		Rest API 키 : <input type="text" id="kakao_rest_api_key" class="form-control" name="kakao_rest_api_key" value="<?=$cfg[sns_login][kakao_rest_api_key]?>" size="40"><p><p>
	      	 		JavaScript 키 : <input type="text" id="kakao_javascript_key" class="form-control" name="kakao_javascript_key" value="<?=$cfg[sns_login][kakao_javascript_key]?>" size="40"><p>
	      	 		<div><span class="notice">[설명]</span> 카카오계정로그인 연동설정시 카카오 개발자센터(<a href="https://developers.kakao.com" target="_blank"><b>https://developers.kakao.com</b></a>)를 통해 발급받은 Rest API 키 / JavaScript 키를 등록해야 정상적으로 연동이 됩니다.</div>
	      	 	</div>
	      	 </div>
	      	 
	      	 <div class="form-group">
	      	 	<label class="col-md-2 control-label"><?=_("페이스북계정로그인<br>사용여부")?></label>
	      	 	<div class="col-md-10">
	      	 		<input type="radio" class="radio-inline" name="facebook_login_use" value="N" <?=$checked[facebook_login_use][N]?> onclick="divHide(this);"> 사용안함
      	 			<input type="radio" class="radio-inline" name="facebook_login_use" value="Y" <?=$checked[facebook_login_use][Y]?> onclick="divShow(this);"> 사용
	      	 	</div>
	      	 </div>
	      	 ...
	      	 <div class="form-group notView" id="facebook_login_use_div">
	      	 	...
	      	 	<div class="col-md-10 form-inline">
	      	 		...
	      	 		<div><span class="notice">[설명]</span> 페이스북계정로그인 연동설정시 페이스북 개발자센터(<a href="http://developers.facebook.com/apps" target="_blank"><b>http://developers.facebook.com/apps</b></a>)를 통해 발급받은 APP ID를 등록해야 정상적으로 연동이 됩니다.</div>
	      	 	</div>
	      	 </div>
