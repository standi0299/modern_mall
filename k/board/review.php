...
$m_goods = new M_goods();
$r_bottommenu = array("review_emoney"=>"적립금발급","review_delete"=>"일괄삭제");
            ...
            <div class="panel-body panel-form">
               <form class="form-horizontal form-bordered" method="post" action="review.php">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-10 form-inline">
                        <input type="text" class="form-control" name="emoney[]" size="8" type2="number" value="<?=$_POST[emoney][0]?>"> 원 ~ 
                        <input type="text" class="form-control" name="emoney[]" size="8" type2="number" value="<?=$_POST[emoney][1]?>"> 원
                     </div>
                     <div class="col-md-1">
                           ...
                           <tbody>
                              <? if($list) {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                    	<div>사용자:<?=($value[review_deny_user]) ? "<b class='red'>N</b>" : "<b class='green'>Y</b>" ?></div>
										<div>관리자:<?=($value[review_deny_admin]) ? "<b class='red'>N</b>" : "<b class='green'>Y</b>" ?></div>
                                    </td>
                                    <td>
