            ...
            <form class="form-horizontal form-bordered" name="fm" method="POST" action="indb.php" enctype="multipart/form-data" onsubmit="return chkForm(this)">
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10">
                  	...
                  	<label class="col-md-3 control-label"><?=_("상품명")?> : <?=strip_tags($data[goodsnm])?></label>
                    <label class="col-md-3 control-label"><?=_("판매가격")?> : <b><?=number_format($data[price])?>원</b></label> 
                  </div>
               </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10">
                     <a href="javascript:;" onclick="popup('../order/order.p.php?payno=<?=$data[payno]?>',800,700)"><b><?=$data[payno]?></b></a>_<?=$data[ordno]?>_<?=$data[ordseq]?>
                  </div>
               </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10">
					<input type="radio" name="review_deny_admin" class="radio-inline" value="0" <?=$checked[review_deny_admin][0]?>> 노출
					<input type="radio" name="review_deny_admin" class="radio-inline" value="1" <?=$checked[review_deny_admin][1]?>> 노출안함                    
                  </div>
               </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10">
					<input type="radio" name="review_deny_user" class="radio-inline" value="0" <?=$checked[review_deny_user][0]?> disabled> 노출
					<input type="radio" name="review_deny_user" class="radio-inline" value="1" <?=$checked[review_deny_user][1]?> disabled> 노출안함               
                  </div>
               </div>
               ...
               <? if ($data[kind] == "photo") { ?>
	                  ...
	                  <div class="col-md-10 form-inline">
	                  	 ...
	                  	 <? if ($data[img]) { ?>
	                  	 	  <div style="margin-left:5px;display:inline-block;cursor:pointer;" onclick="$j(this).closest('div').next().toggle();">이미지보기</div>
