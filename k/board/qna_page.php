...
$order_column_arr = array("no", "subject", "name", "regdt", "status", "", "");
...
foreach ($list as $key => $value) {
   $cs_answer = "<button type=\"button\" class=\"btn btn-xs btn-primary\" onclick=location.href=\"qna.w.php?no=".$value[no]."\">"._("수정")."</button>";
   $cs_delete = "<button type=\"button\" class=\"btn btn-xs btn-danger\" onclick=\"qna_delete('".$value[no]."');\">"._("삭제")."</button>";
   $cs_subject = "<a href='qna.w.php?no=".$value[no]."'>".$value[subject]."</a>";
