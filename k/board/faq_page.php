...
foreach ($list as $key => $value) {
   $faq_popup = "<button type=\"button\" class=\"btn btn-xs btn-primary\" onclick=\"faq_popup('".$value[no]."');\">"._("수정")."</button>";
   $faq_delete = "<button type=\"button\" class=\"btn btn-xs btn-danger\" onclick=\"faq_delete('".$value[no]."');\">"._("삭제")."</button>";
