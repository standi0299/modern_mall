...
<div id="content" class="content">
   ...
   <div class="panel panel-inverse"> 
      <div class="panel-heading">
         <h4 class="panel-title"><?=_("일자별접속")?></h4>
      </div>
         ...
         <div class="panel-body">
         	<div class="table-responsive">
         		<table id="data-table" class="table table-hover table-bordered">
         			...
         			<tbody>
         			<? foreach ($loop as $k=>$v) {
						 $b_day = date("Y-m-d", strtotime($k." -1 days"));
						
						 $b[p] = $loop[$b_day][p];
						 $b[u] = $loop[$b_day][u] + $loop[$b_day][r];
						
						 @$v[p_per] = ($v[p] - $b[p])/$b[p];
						 @$v[u_per] = ($v[u]+$v[r] - $b[u])/$b[u];
						 @$v[p_per_u] = number_format(($v[p]/($v[u]+$v[r]))*100, 2)." %";
