...
$r_portal = array(
	"naver"=>array("search.naver.com","네이버키워드"),
	"navershopping"=>array("shopping.naver.com","네이버지식쇼핑"),
	"daum"=>array("search.daum.net","다음키워드"),
	"daumshopping"=>array("shopping.daum.net","다음쇼핑하우"),
	"nate"=>array("search.nate.net","네이트"),
	"google"=>array("google.co.kr","구글"),
	"about"=>array("about.co.kr","어바웃"),
);
