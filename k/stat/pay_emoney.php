...
### TOTAL 미사용 총 적립금 추출
$total_emoney = $m_member->getNotUseEmoney();
...
$data = $m_etc->getSoldPayEmoney($cid, $startDate, $endDate);
...
<div id="content" class="content">
   ...
   <div class="panel panel-inverse"> 
      <div class="panel-heading">
         <h4 class="panel-title"><?=_("결제일기준 적립금통계")?></h4>
      </div>
      ...
      <div class="panel-body panel-form">
         ...
         <div class="panel-body">
         	<div class="table-responsive">
         		<div align="right">TOTAL 미사용 총 적립금 : <b class="red"><?=number_format($total_emoney)?></b> 원</div><p>
         		<table id="data-table" class="table table-hover table-bordered">
         			...
         			?>
         				<tr align="right">
         					<td width="150" align="center"><?=$v[paydt]?></td>
...
<? include "../_footer_app_exec.php"; ?>s