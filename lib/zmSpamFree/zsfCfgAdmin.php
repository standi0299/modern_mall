...
$zsfCfg['distortion'] = 1;	# 문자 왜곡 여부, 0: 안함, 1: 왜곡함 (text distortion, 0: no, 1: yes) 왜곡을 설정할 경우엔 글꼴 크기를 더 크게 적당히 조정하셔야 합니다.
...
#$zsfCfg['fontName'] = array ( 'Tahoma24px', 'TimesNewRoman26px', 'Arial26px', 'YDISomaL26px', 'PyunjiR24px', 'Impact27px', 'Gulim26px', 'Gungsuh27px', 'MalgunGothic24px' );	# [②작은 글꼴]
	...
	*/
$zsfCfg['font-size'] = 32;		# 이미지 글꼴 크기 (픽셀)
$zsfCfg['width'] = 0;			# 이미지 폭 (픽셀) : 0으로 설정하면 이미지 폭이 가변적이어서, 필요만큼 늘어나고 줄어듭니다.
$zsfCfg['height'] = 35;			# 이미지 높이 (픽셀)
$zsfCfg['padding-left'] = 3;	# 이미지 박스 안 글자의 왼쪽 여백 (픽셀)
...
$zsfCfg['view'] = 3;
	...
	*/
$zsfCfg['codeCfg'] = array ( 1=>4, 2=>4, 3=>2, 4=>2, 5=>1, 6=>4, 7=>4, 8=>6 );
