...
?>
<div class="stit" align="center"><?=_("거래명세서")?></div>

<form method="post" action="indb.details.php" onsubmit="return form_chk_xls(this)" name="fm">
<input type="hidden" name="mode" value="xls"/>
<input type="hidden" name="mode_opt" value="download"/>
...
<tr >
    ...
    <td style="padding:0;border:1;font-size:0;" valign="bottom" align="right">
...
<div id="column_container" align="center">
...
<div class="column_select_title"><?=_("명세표출력항목")?></div>
<select name="columns[]" multiple="true" class="column_select" label='<?=_("명세표출력항목")?>' id="column_select" style="height:268px">
...
$j("#no_select").change(function(){
    ...
    location.href = "xls.case.php?mode=<?=$_GET[mode]?>&query=<?=$_GET[query]?>&no="+no;
    return;
    form_chk_mode();
    });
...
#column_select_div_left {top:10px;left:450px;background:black;}
#column_select_div_right {top:10px;right:450px;background:#336699;}
