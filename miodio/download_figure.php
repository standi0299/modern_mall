...
* @date : 20180829
* @author : kdk
* @brief : 미오디오용 피규어 사용자 원본 이미지 다운로드.
* @desc : http://storage.wecard.co.kr/zipfile_down/zipFile.ashx
*/
...
$url = "http://storage.wecard.co.kr/zipfile_down/zipFile.ashx";
$returl = $url."?site_id=$cid&sid=".$_GET[sid];
