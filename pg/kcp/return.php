...
if ($data[payno] && !$data[paydt]) {
   ...
   if ($req_tx == "pay") {
      if ($res_cd == "0000") {
         ...
         ### 적립금 잔액 여부 체크, 잔액이 적을경우 결제 실패 처리.
         $bSucc = "";
         ...
         if ($bSucc == "false") {
            ...
            $c_PayPlus -> mf_do_tx($tno, $g_conf_home_dir, $site_cd, $site_key, $tran_cd, "", $g_conf_pa_url, $g_conf_pa_port, "payplus_cli_slib", $ordr_idxx, $cust_ip, $g_conf_log_level, 0, $g_conf_mode);
