...
<?
    ...
    /* = -------------------------------------------------------------------------- = */
     ...
     include_once dirname(__FILE__) ."/site_conf_inc.php";       // 환경설정 파일 include
...
<form name="order_info" method="post">
  ...
  <div class="sample">
    ...
    <table class="tbl" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td>
            <select name="ActionResult" onchange="jsf__chk_type();">
                ...
                <option value="card" <? if ($paymethod=='c') echo "selected"; ?>>신용카드</option>
                <option value="acnt" <? if ($paymethod=='c') echo "selected"; ?>>계좌이체</option>
                <option value="vcnt">가상계좌</option>
                <option value="mobx" <? if ($paymethod=='c') echo "selected"; ?>>휴대폰</option>
      ...
      <tr>
        <th>상품명</th>
        <td><input type="text" name="good_name" class="w100" value="<?=$pg_goodsnm?>"></td>
      </tr>
      <tr>
        <th>결제 금액</th>
      ...
      <tr>
        <th>주문자명</th>
        <td><input type="text" name="buyr_name" class="w100" value="<?=$orderer_name?>"></td>
      </tr>
      <tr>
        <th>E-mail</th>
