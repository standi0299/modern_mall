<?php
    ...
    $LGD_HASHDATA2 = md5($LGD_MID.$LGD_OID.$LGD_AMOUNT.$LGD_RESPCODE.$LGD_TIMESTAMP.$LGD_MERTKEY); 
		...
		//테스트를 위한 처리값 셋팅
		$LGD_HASHDATA2 = $LGD_HASHDATA;
		$LGD_RESPCODE = "0000"; 
		
		
		$LGD_OID = "1452583248427";			//가상
		$LGD_PAYTYPE = "SC0040";
		$LGD_CASFLAG = "R";		//가상계좌 요청
		
		//$LGD_OID = "1452582587031";			//카드
		//$LGD_PAYTYPE = "SC0010";
  		...
  		$step		= 2;
			...
			switch ($LGD_PAYTYPE)
			{
				...
				case "SC0030": //계좌이체
					...
					$pglog .= "
						결제방법 : 계좌이체
						계좌이체 : $LGD_FINANCENAME $LGD_ACCOUNTNUM
						";
		
						break;
		
				case "SC0040": //가상계좌(무통장)
					$bankinfo	= "$LGD_FINANCENAME $LGD_ACCOUNTNUM";
