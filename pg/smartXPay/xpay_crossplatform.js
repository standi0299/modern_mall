	...
	if (isPopup) {
		...
		if (formid.elements[popupName] == null) {
			...
			if (formid.elements["LGD_SELF_CUSTOM"] == null || formid.elements["LGD_SELF_CUSTOM"].value == "N") {
				...
				installpop += "<div id=\"" + popupName + "_div\" style=\"position:fixed; top:0; left:0; width:100%; height:100%; z-index:20000000000000000000000000;\">";
				installpop += "<iframe id=\"" + popupName + "_iframe\" name=\"" + popupName + "_iframe\" src=\"\" width=\"100%\" height=\"100%\" scrolling=\"no\" style=\"position:absolute; top:0; left:0; width:100%; height:100%; line-height:450px; z-index:20000000000000000000000000;\"></iframe>";
				installpop += "</div>";
			}
